...
const conversionMatrix = reactive([
  {
    sourceFormat: "PNG",
    targetFormats: ["JPG", "WEBP", "BMP", "SVG"],
    icon: "pi pi-image",
  },
  {
    sourceFormat: "JPG/JPEG",
    targetFormats: ["PNG", "WEBP", "BMP", "SVG"],
    icon: "pi pi-image",
  },
  {
    sourceFormat: "DOCX",
  ...
  {
    sourceFormat: "WEBP",
    targetFormats: ["PNG", "JPG", "SVG"],
    icon: "pi pi-image",
  },
  {
    sourceFormat: "BMP",
    targetFormats: ["PNG", "JPG", "WEBP", "SVG"],
    icon: "pi pi-image",
  },
  {
    sourceFormat: "MP3",
    targetFormats: ["WAV", "OGG", "AAC"],
    icon: "pi pi-volume-up",
  },
  {
    sourceFormat: "WAV",
    targetFormats: ["MP3", "OGG", "AAC"],
    icon: "pi pi-volume-up",
  },
  {
    sourceFormat: "OGG",
    targetFormats: ["MP3", "WAV", "AAC"],
    icon: "pi pi-volume-up",
  },
  {
    sourceFormat: "AAC",
...
const filteredConversions = computed(() => {
  ...
  return conversionMatrix.filter(
    (item) =>
      item.sourceFormat.toLowerCase().includes(lowerCaseQuery) ||
      item.targetFormats.some((format) =>
          ...
          <div class="card-title">
            ...
            <span v-if="store.uploadedFile" class="file-badge">
              <i
                :class="
                  getFormatIcon(
                    store.uploadedFile.name.split('.').pop()?.toLowerCase() ||
                      ''
                  )
                "
              ></i>
        ...
        <template #content>
          ...
          <div class="step-content">
            ...
            <div v-if="activeIndex === 0" class="upload-step">
              <div class="upload-container">
                ...
                <div class="security-tip">
                  ...
                  <span
                    >完全由客户端完成转换，无需上传至服务器，简洁安全放心</span
                  >
                </div>
              </div>
                ...
                <div class="conversion-table">
                  ...
                  >
                    ...
                    <div class="target-formats">
                      <span
                        v-for="(format, idx) in item.targetFormats"
                        :key="idx"
                        class="format-tag"
                      >
                        {{ format }}
            ...
            <div v-if="activeIndex === 1" class="format-step">
              <div class="current-file">
                <div class="file-info" v-if="store.uploadedFile">
                  ...
                  <span class="file-size"
                    >({{
                      (store.uploadedFile.size / 1024).toFixed(1)
                    }}
                    KB)</span
                  >
                </div>
              ...
              <!-- 媒体文件预览 -->
              <div
                v-if="showMediaPreview && mediaPreviewUrl"
                class="media-preview"
              >
                <h3>文件预览</h3>
                <div class="preview-container">
                  ...
                  <audio
                    v-if="
                      store.uploadedFile?.name.match(/\.(mp3|wav|ogg|aac)$/i)
                    "
                    controls
                    :src="mediaPreviewUrl"
                    class="audio-preview"
              ...
              <div class="format-selection">
                ...
                <div class="format-options">
                  <div
                    v-for="format in store.targetFormats"
                    :key="format"
                    class="format-option"
              ...
              <div class="conversion-summary">
                ...
                <div class="summary-item to">
                  ...
                  <div class="summary-value">
                    <i
                      :class="
                        getFormatIcon(store.selectedFormat?.toLowerCase() || '')
                      "
                    ></i>
              ...
              <div class="convert-tips" v-if="isMediaFile(store.uploadedFile!)">
                <div class="info-box">
                  ...
                  <div class="info-content">
                    ...
                    <ul>
                      <li>
                        音频格式：支持基本的格式转换，但某些编解码可能受限
                      </li>
                      <li>视频格式：浏览器环境下只能进行基本的格式切换</li>
                      <li>
                        大文件处理：媒体文件通常较大，处理可能需要较长时间
                      </li>
                    </ul>
                  </div>
                </div>
